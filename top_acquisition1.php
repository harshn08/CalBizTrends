...
$query1=mysql_query("SELECT company_name, acquirer_name, (price_amount/1000000000) as amount
FROM  `acquisitions` 
...
$series2 = array();
$series2['name'] = 'acquirer_name';

//$series3 = array();
//$series3['name'] = '2013';
while($r = mysql_fetch_array($query1)) {
    $category['data'][] = $r['company_name'];
    $series1['data'][]=$r['amount'];
	$series2['data'][]=$r['acquirer_name'];
}
